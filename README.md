...
- ARB, maker, paired-sniper, oracle-arb, and midmarket-maker remain experimental and are blocked unless the operator explicitly sets `ALLOW_EXPERIMENTAL_STRATEGIES=true`.
